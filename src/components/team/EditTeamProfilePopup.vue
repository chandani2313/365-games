    ...
    <div class="main__container">
      <div class="table__wrapper animated zoomIn">
        <div class="top_container">
          <div class="navbar_text">Edit Team</div>
          ...
          <form>
            <div class="container">
              <div class="input-wrapper">
                ...
                />
                <div v-if="teamNameErr" class="err-text">
                  {{ teamNameErr }}
                </div>
              </div>
              <div class="input-wrapper">
                ...
                />
                <div v-if="teamAliasErr" class="err-text">
                  {{ teamAliasErr }}
                </div>
              </div>
              <div class="input-wrapper">
                <input
                  ...
                  placeholder="Game"
                />
                <div v-if="gameErr" class="err-text">
                  {{ gameErr }}
                </div>
              </div>
              <div class="input-wrapper">
                ...
                />
                <img
                  src="../../assets/username/selectarrow.svg"
                  style="    position: absolute;top: 28px;right: 25px;"
                />
              </div>
              <div v-if="countryErr" class="err-text">
                {{ countryErr }}
              </div>
              <div class="input-wrapper">
                <VuePhoneNumberInput
                ...
                <div v-if="phoneErr" class="err-text">
                  {{ phoneErr }}
                </div>
              </div>
            </div>
...
export default {
  ...
  created() {
    ...
    this.game = this.team?.game?.shortName;
  ...
  methods: {
    ...
    validate() {
      ...
      if (this.phone === "") {
        this.phoneErr = "This Field Is Required.";
      } else {
        this.phoneErr = "";
      }
      if (
