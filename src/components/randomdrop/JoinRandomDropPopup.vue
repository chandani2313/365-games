<template>
  ...
  <div class="main__container">
      <div class="table__wrapper animated zoomIn">
        ...
        <div class="bottom_container">
          ...
          <div class="bottom-text"> Are you sure want to join this event using?</div>
          <div class="button__wrapper">
              <button class="btn" @click="close()">Cancel</button>
              <button class="btn" @click="joinRandom()">Join Now</button>
            </div>
        </div>
      </div>
  ...
  <v-dialog persistent max-width="400px" v-model="isDialogComplete">
    <div class="popup-container-ticket">
      ...
      <button class="btn-submit" @click="closeTicket()">Completed</button>
    </div>
  </v-dialog>
  </div>
  <!-- <div>
    <v-dialog persistent style="background: rgba(19, 19, 19, 0.7); backdrop-filter: blur(7px);" v-model="isDialogOpen">
      <div class="container">
        <div
          class="panel"
          ref="panel"
  ...
  methods: {
    joinRandom() {
      axios
        ...
        .then((response) => {
          console.log("joinevent random", response.data);
