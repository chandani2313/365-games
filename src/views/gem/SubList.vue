    ...
    <div class="redeem_outer_container">
        <div class="redeem_container">
            <div class="product_heading_wrap">
                <div class="product_heading">subscription Purchase</div>
            </div>
            <div class="product_card_container" >
                <div class="product_cards">
                    ...
                    <div class="gems_wrap">{{subData.price}} $</div>
                </div>
                <div class="product_details_wrap">
                    <div class="product_top_outer">
                        <div class="product_top">
                            <div class="product_name">{{subData.name}} SUBSCRIPTION</div>
                            <div class="amount"><span>&#x24;</span> {{ subData.price }}</div>
            ...
            <div class="total_items_outer">
                ...
                <div class="amount"> <span>&#x24; {{subData.price}}</span></div>
                ...
                <div class="buy_button" @click="buyNow(subData._id)">proceed to buy</div>
            </div>
        </div>
        <v-snackbar
            v-model="snackbar"
...
export default {
  ...
  methods: {
    getGemList() {
      axios
        .get("subscription-pack/find/".concat(this.$route.params.id))
        .then((response) => {
            console.log("sub response",response.data)
            this.subData = response.data;
            console.log("sub list", this.subData);
        })
        .catch((e) => {
