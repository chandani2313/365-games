...
<div class="tour_out">
  <div class="tournament">
    ...
    <div class="inner_container">
      ...
      <router-view :tournaments="tournaments" />
...
export default {
  ...
  data() {
    return {
      ...
      tournamentState: this.$route.name,

      tabs: [
        {
          routeName: "AllTournament",
          name: "All",
        },
        {
          routeName: "RegistrationTournament",
          name: "Registration",
        },
        {
          routeName: "UpcomingTournament",
          name: "Upcoming",
        },
        {
          routeName: "OngoingTournament",
          name: "Ongoing",
        },
        {
          routeName: "CompletedTournament",
          name: "Completed",
        },
      ],
    };
  ...
  methods: {
    ...
    getAllGames() {
      axios
        ...
        .then((response) => {
          console.log("tou tournament", response.data);
    ...
    getAllTournaments() {
      ...
      if (this.selectedGameId !== "all-games") {
        console.log("selected gasme", this.selectedGameId);
        criteria["game"] = this.selectedGameId;
      }
      switch (this.$route.name) {
        case "OngoingTournament": {
          criteria["schedule.tournamentStart"] = {
            $lte: new Date(),
          };
          criteria["schedule.tournamentEnd"] = {
            $gt: new Date(),
          };
          break;
        }
  ...
  watch: {
    "$route.name": {
      immediate: true,
      handler() {
        this.tournamentState = this.$route.name;
